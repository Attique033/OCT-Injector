...
public class ExpandableCardView extends LinearLayout {
    ...
    private void initAttributes(Context context, AttributeSet attrs){
        ...
        title = typedArray.getString(R.styleable.ExpandableCardView_titlee);
        iconDrawable = typedArray.getDrawable(R.styleable.ExpandableCardView_iconn);
    ...
    protected void onFinishInflate() {
        ...
        headerIcon = (ImageButton) findViewById(R.id.icon);
